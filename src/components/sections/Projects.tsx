...
const projects = [
  {
    id: 1,
    title: "Tier 1 Banking Client",
    description: "A electronic trading system for Forex Trading with real-time features and modern UI/UX design.",
    image: "https://via.placeholder.com/400x200",
    techStack: ["React", "SpringBoot", 'Redux', 'Typescript', "MongoDB", 'JavaScript', "Socket.IO"],
  },
  {
    id: 2,
    title: "Tier 1 Financial Client",
    description: "A Loan Management System with a focus on security and performance.",
    image: "https://via.placeholder.com/400x200",
  ...
  },
  {
    id: 3,
    title: "Infosys",
    description: "Coordinated multi-channel marketing collateral to ensure consistent branding and messaging. Involved in the design and technical development of SAP MM solutions, including screen creation using SAP-ABAP and performance improvements, while communicating with clients on issue resolution and updates. ",
    image: "https://via.placeholder.com/400x200",
    techStack: ["SAP-ABAP"],
    githubUrl: "https://github.com",
    liveUrl: "https://example.com",
